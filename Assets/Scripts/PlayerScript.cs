...
public class PlayerScript : MonoBehaviour
{
    ...
    bool IsGrounded()
    {
        Vector2 offsetLeftUp = new Vector2(0, 1f);
        Vector2 offsetLeftDown = new Vector2(0, -1f);
        Vector2 offsetRightUp = new Vector2(0, 1f);
        Vector2 offsetRightDown = new Vector2(0, -1f);
        Vector2 offsetDownLeft = new Vector2(-1f, 0);
        Vector2 offsetDownRight = new Vector2(1f, 0);
